...
import "./REAuction.sol";

contract REMarket is ERC721Full, Ownable {

    constructor() ERC721Full("REMarket", "REAL") public {} //REAL is the name of the token
    ...
    function endAuction(uint token_id) public onlyOwner landRegistered(token_id) {
        REAuction auction = auctions[token_id];
        auction.auctionEnd();
