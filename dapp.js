// @TODO: Update this address to match your deployed PromotionalMarket contract!
const contractAddress = "0x5BF91e139cBF864BAC7a4139e2BE356E932a6485";
...
const dApp = {
  ...
  main: async function() {
    ...
    this.marsJson = await (await fetch("./PromotionalMarket.json")).json();
    this.auctionJson = await (await fetch("./PromotionalAuction.json")).json();
